...
Accounts.ui.config({
    ...
    extraSignupFields: [{
        ...
        data: [{                    // Array of radio options, all properties are required
            ...
            label: 'Yes, this is an user group account.',          // label for the radio element
            value: true              // value of the radio element, this will be saved.
          }, {
            id: 2,
            label: 'This is not an user group account.',
            value: false,
            checked: 'checked'
        }],
        visible: true
